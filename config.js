...
module.exports = {
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "TRXSHANA⚡",           // Owner's name
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ trxshana⚡o_O*",  // Bot description
